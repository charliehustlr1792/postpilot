...
exports.validatePostForPlatform = exports.refreshAccessToken = exports.publishPostToSocialMedia = void 0;
const db_1 = __importDefault(require("../lib/db"));
const publishPostToSocialMedia = async (post) => {
    try {
...
exports.publishPostToSocialMedia = publishPostToSocialMedia;
...
const refreshAccessToken = async (socialAccountId) => {
    const account = await db_1.default.socialAccount.findUnique({
...
const validatePostForPlatform = (post) => {
    const errors = [];
    switch (post.account.platform) {
        case 'TWITTER':
...
exports.validatePostForPlatform = validatePostForPlatform;
