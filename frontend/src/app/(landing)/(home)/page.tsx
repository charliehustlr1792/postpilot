  ...
  return (
    <>
      <div className='relative w-full min-h-screen bg-[#F3EFEC] overflow-hidden pt-[90px] pb-20'>
        ...
        {/* SVG Elements - Hidden on mobile */}
        <svg className="absolute left-[731px] top-[168px] w-[50px] h-[1px] hidden xl:block" width="50" height="1" viewBox="0 0 50 1" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 0.5L50 0V1L0 0.5Z" fill="#FF9B4F" />
        </svg>
        <svg className="absolute left-[1201px] top-[175px] w-[39px] h-[34px] hidden xl:block" width="39" height="34" viewBox="0 0 39 34" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M38.5211 0.618022L0.645958 33.2634L0.000689864 32.4995L38.5211 0.618022Z" fill="#FF9B4F" />
        </svg>
        <svg className="absolute left-[1127px] top-[365px] w-[39px] h-[34px] hidden xl:block" width="39" height="34" viewBox="0 0 39 34" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M38.5211 0.618022L0.645958 33.2634L0.000689864 32.4995L38.5211 0.618022Z" fill="#FF9B4F" />
        </svg>
        <svg className="absolute left-[274px] top-[365px] w-[40px] h-[33px] hidden xl:block" width="40" height="33" viewBox="0 0 40 33" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0.178491 0.714628L39.2907 31.8672L38.6599 32.6432L0.178491 0.714628Z" fill="#FF9B4F" />
        </svg>
        <svg className="absolute left-[201px] top-[175px] w-[40px] h-[33px] hidden xl:block" width="40" height="33" viewBox="0 0 40 33" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="relative w-full flex flex-col items-center px-4 sm:px-6 md:px-8">
          <div className="flex flex-col items-center gap-8 sm:gap-10 md:gap-[42px] w-full max-w-[734px] mt-12 sm:mt-16 md:mt-[78px]">
            <div className="flex flex-col items-center gap-4 sm:gap-5 md:gap-[18px] w-full">
              <div className="flex h-[34px] px-[14px] py-2 justify-center items-center gap-1 rounded-[100px] border border-[#EAE7E4] bg-white">
                <span className="text-[#4D4946] text-sm sm:text-base font-[420] leading-[19px]" style={{ fontFamily: 'Inter, -apple-system, Roboto, Helvetica, sans-serif' }}>
              ...
              <div className="flex flex-col items-center gap-4 sm:gap-5 w-full">
                <h1 className="w-full text-[#181817] text-center text-3xl sm:text-5xl md:text-6xl lg:text-[82px] font-bold leading-tight sm:leading-[52px] md:leading-[68px] lg:leading-[86px] px-4">
                ...
                <p className="w-full max-w-[518px] text-[#4D4946] text-center text-base sm:text-lg md:text-xl leading-6 sm:leading-7 px-4">
                  Schedule smarter, post faster, and grow effortlessly<br className="hidden sm:block" />with PostPilot, your AI-powered social media copilot.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className='flex flex-col items-center gap-12 sm:gap-16 md:gap-20 w-full mt-12 sm:mt-16 md:mt-[78px] px-4 sm:px-6 md:px-8'>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-[1028px] gap-6 sm:gap-8">
            <div className="flex-1 text-center lg:text-left order-1">
              ...
              <p className="text-[#4D4946] text-base sm:text-lg md:text-xl leading-6 sm:leading-7">
                Track the performance of all your posts on PostPilot. Get insights into views, conversions, and more to optimize your social media strategy.
              </p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-[1028px] gap-6 sm:gap-8">
            ...
            <div className="flex-1 text-center lg:text-left order-1 lg:order-2">
              ...
              <p className="text-[#4D4946] text-base sm:text-lg md:text-xl leading-6 sm:leading-7">
                Plan and schedule your social media posts effortlessly with our calendar interface. Stay organized and consistent with your content strategy.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-[1028px] gap-6 sm:gap-8">
            <div className="flex-1 text-center lg:text-left order-1">
              ...
              <p className="text-[#4D4946] text-base sm:text-lg md:text-xl leading-6 sm:leading-7">
                Craft engaging content for all your social platforms in one place. Schedule posts, add media, and manage everything from a single, intuitive interface.
              </p>
            </div>
            <div className="flex-shrink-0 order-2">
              <CreatePostCard />
